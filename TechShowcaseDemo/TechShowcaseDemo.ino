// Added for improved sending capabilities
#include <IRtimer.h>
#include <IRutils.h>
#include <ir_Argo.h>
#include <ir_Coolix.h>
...
int deviceControl(String command) {
  ...
  case 1:
    irsend.sendNEC(power_button_fan,32);
    break;
  case 2:
    irsend.sendNEC(dir_change_fan,32);
    break;
  case 3:
    irsend.sendNEC(timer_set_fan,32);
    break;
  case 4:
    irsend.sendNEC(top_left_fan,32);
    break;
  default:
    break;
}
